...
OCNI_PURGE_DB = config['OCNI_PURGE_DB']
OCNI_DUMMY = config['OCNI_DUMMY']
OCNI_OPENFLOW = config['OCNI_OPENFLOW']
OCNI_L3VPN = config['OCNI_L3VPN']
OCNI_OPENNEBULA = config['OCNI_OPENNEBULA']
OCNI_OPENSTACK = config['OCNI_OPENSTACK']
OCNI_LIBNETVIRT = config['OCNI_LIBNETVIRT']
